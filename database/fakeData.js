...
let seedData = (number) => {
  ...
  for (let i = 0; i < number; i++) {
    ...
    let imageCount = Math.floor((Math.random() * 16) + 6);
    let randomImages = randomImagesArray(imageCount, imageBank);
